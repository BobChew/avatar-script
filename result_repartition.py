...
if __name__ == "__main__":
    if len(sys.argv) != 10:
        ...
        for acc_level in ["high", "mid", "low"]:
            ...
            acc_file = open(result_repo + "active_result_" + traj_info + acc_level + "_acc_" + strategy + "_" + order + "_time.json", "r")
            time_file = open(result_repo + "active_result_" + traj_info + acc_level + "_acc_" + strategy + "_" + order + "_acc.json", "r")
